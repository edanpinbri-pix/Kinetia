...
const FEATURES = [
  {
    Icon: IconBrain,
    title: "Learn from references",
    description: "Upload MP4 videos — Kinetia extracts the motion skeleton using Claude Vision. Easing, velocity, bounce — not pixels.",
    from: "#1b1f4e",
    to: "#2c3482",
    accent: "#7f96f7",
  },
  {
    Icon: IconBolt,
    title: "Physics-driven presets",
    description: "Every preset is a mathematical description of motion. Apply it to any PSD layer and the physics engine handles the rest.",
    from: "#0f1117",
    to: "#1e2235",
    accent: "#5f72f0",
  },
  {
    ...
    description: 'Tell Kinetia "make it softer and floatier" — the AI translates your words into precise physics modifier changes.',
    from: "#1b1f4e",
    to: "#3b42ca",
    accent: "#a5bcfb",
  },
  {
    Icon: IconLayers,
    title: "Smart layer mapping",
    description: "Kinetia reads your PSD/AI hierarchy and automatically matches presets to the right layer types.",
    from: "#0f1117",
    to: "#2a2f47",
    accent: "#5f72f0",
  },
  {
    ...
    description: "One-click export generates a fully editable AE project with live text, editable vectors, and injected expressions.",
    from: "#1b1f4e",
    to: "#2c3482",
    accent: "#7f96f7",
  },
  {
    Icon: IconPlug,
    title: "Native AE plugin",
    description: "Import Kinetia packages directly into After Effects and fine-tune physics without breaking the animation.",
    from: "#0f1117",
    to: "#3b42ca",
    accent: "#a5bcfb",
  },
